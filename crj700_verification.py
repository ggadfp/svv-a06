...
print("Moment of inertia Izz", crosssection.Izz)
...
print("Y-coordinate of shear center", crosssection.ysc)
print("Z-coordinate of shear center", crosssection.zsc)
...
print("Max shear flow in region 1:", max(Stressobject.q1f(theta)))
print("Max shear flow in region 2:", max(Stressobject.q2f(y)))
print("Max shear flow in region 3:", max(Stressobject.q3f(s)))
print("Max shear flow in region 4:", max(Stressobject.q4f(s)))
print("Max shear flow in region 5:", max(Stressobject.q5f(y)))
print("Max shear flow in region 6:", max(Stressobject.q6f(theta)))

print("Max direct stress in region 1:", max(Stressobject.sigma1f(theta)))
print("Max direct stress in region 2:", max(Stressobject.sigma2f(y)))
print("Max direct stress in region 3:", max(Stressobject.sigma3f(s)))
print("Max direct stress in region 4:", max(Stressobject.sigma4f(s)))
print("Max direct stress in region 5:", max(Stressobject.sigma5f(y)))
print("Max direct stress in region 6:", max(Stressobject.sigma6f(theta)))

print("Max Von Mises stress in region 1:", max(Stressobject.vm1(theta)))
print("Max Von Mises stress in region 2:", max(Stressobject.vm2(y)))
print("Max Von Mises stress in region 3:", max(Stressobject.vm3(s)))
